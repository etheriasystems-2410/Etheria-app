...
const translations = {
  en: {
    ...
    free: 'Free',
    locked: 'Locked',
    loadingModules: 'Loading training modules...',
    developAbilities: 'Develop your psychic abilities through structured lessons and guided exercises.',
    startLesson: 'Start Lesson',
    nextLesson: 'Next Lesson',
    previousLesson: 'Previous',
    completeLesson: 'Complete & Continue',
    meditationExercise: 'Meditation Exercise',
    playMeditation: 'Play Guided Meditation',
    stopMeditation: 'Stop Meditation',
    meditationComplete: 'Meditation Complete',
    returnToAwareness: 'Take a moment to return to awareness.',
