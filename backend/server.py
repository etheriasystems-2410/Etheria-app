...
from routes.training_workbook import router as training_workbook_router
app.include_router(training_workbook_router, prefix="/api")
...
# Pexels themed video loops for the Reprogramming visual layer.
